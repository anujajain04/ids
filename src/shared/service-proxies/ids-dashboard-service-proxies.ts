...
export class DashboardService {
    ...
    updateDashBoard(input: any, value: any): Observable<CreateDashBoardDto> {
        return this.http.request(TempBaseUrl.BASE_URL + "dashboard/"+value, {
            body: input,
            method: "put",
            headers: new Headers({
                "Content-Type": "application/json; charset=UTF-8",
    ...
    protected processUpdateDash(response: Response): CreateDashBoardDto {
        const responseText = response.text();
        const status = response.status;
        if (status === 200) {
            let result: CreateDashBoardDto;
            let result200 = responseText == "" ? null : JSON.parse(responseText, this.jsonParseReviver);
            result = CreateDashBoardDto.fromJS(result200);
            return result;
        }
        return null;
    }
    ...
    editDashboard(input: string): Observable<CreateDashBoardDto> {
        debugger;
        return this.http.request(TempBaseUrl.BASE_URL + "dashboard/" + input, {
            method: "get",
            headers: new Headers({
    ...
    protected processeditDashboard(response: Response): CreateDashBoardDto {
        debugger;
        const responseText = response.text();
        const status = response.status;
        if (status === 200) {
            ...
            /*if (result200["DashboardDetails"] && result200["DashboardDetails"].constructor === Array) {
                let p = result200["DashboardDetails"];
                for (let item of p) {
                    result.push(CreateDashBoardDto.fromJS(item));
                }
                debugger;
                return result;
            }*/
    ...
    filterLocal(value: any): Observable<ChartWidgets> {
        return this.http.request(TempBaseUrl.BASE_URL + "dashboard/localFilterDashboard/", {
            body: value,
            method: "post",
            headers: new Headers({
                "Content-Type": "application/json; charset=UTF-8",
    ...
    protected processLocalFilter(response: Response): ChartWidgets {
        debugger;
        const responseText = response.text();
        const status = response.status;
        if (status === 200) {
            let result: ChartWidgets;
            let result200 = responseText == "" ? null : JSON.parse(responseText, this.jsonParseReviver);
            result = ChartWidgets.fromJS(result200.result);
            debugger;
            return result;
        }
        return null;
...
export class DashboardStudioConfig {
    ...
    clearAll() {
        ...
        this.currentModel = new TaskModel();
        this.currentPosition = 0;
        this.taskElements = [];
        this.createDashboard = new CreateDashBoardDto();
    }
}
...
export class CreateDashBoardDto {
    ...
    chartmatrix: any;//ChartAssociationMatrix = new ChartAssociationMatrix();
    //globalFilter
    ...
    constructor(data?: any) {
        ...
        if (data !== undefined) {
            ...
            this.changeFlag = data["changeFlag"] !== undefined ? data["changeFlag"] : "";
            this.entityDescription = data["entityDescription"] !== undefined ? data["entityDescription"] : "";
            this.entityType = data["entityType"] !== undefined ? data["entityType"] : "";
            this.dashboardTitle = data["dashboardTitle"] !== undefined ? data["dashboardTitle"] : "";
            this.dashboardType = data["dashboardType"] !== undefined ? data["dashboardType"] : "";
            ...
            this.chartmatrix = data["chartAssociationMatrix"] !== undefined ? data["chartAssociationMatrix"] : "";//ChartAssociationMatrix.fromJS(data["chartAssociationMatrix"]);
    ...
    toJS(data?: any) {
        ...
        data["chartAssociationMatrix"] = this.chartmatrix !== undefined ? this.chartmatrix : "";//this.chartmatrix.toJS();
        data["globalFilter"] = [];
        debugger;
        if (this.globalFilter && this.globalFilter.constructor === Array) {
            debugger;
            for (let item of this.globalFilter)
                data["globalFilter"].push(item);
        }
...
export class ChartSpecificOptions {
    ...
    constructor(data?: any) {
        if (data !== undefined) {
            ...
            this.chartMapping = data["ChartMapping"];//umesh
        }
    }
    toJS(data?: any) {
        data = data === undefined ? {} : data;
...
export class ChartMapping {
    ...
    constructor(data?: any) {
        if (data !== undefined) {
            ...
            if (data["dimension"] && data["dimension"].constructor === Array) {
                for (let item of data["dimension"])
                    this.dimension.push(Dimension.fromJS(item));
            }
        }
    }
    toJS(data?: any) {
        ...
        data["chartVariable"] = [];
        if (this.dimension && this.dimension.constructor === Array) {
            for (let item of this.dimension)
                data["dimension"].push(item.toJS());
        }
